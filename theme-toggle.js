...
// ---------------------------------------------------------------------------
// SVG icon paths (Docusaurus Icon/LightMode & Icon/DarkMode)
// ---------------------------------------------------------------------------
...
export function initThemeToggle(options) {
  ...
  const sunIcon = createSvgIcon(SUN_PATH, 'theme-toggle-icon-light');
  const moonIcon = createSvgIcon(MOON_PATH, 'theme-toggle-icon-dark');
