import { initReviewWidget, reviewRating, reviewCount, reviewLabel } from '../../dist/reviews.js';

describe('initReviewWidget', () => {
  let container;
  ...
  it('cleanup removes the widget from DOM', () => {
    const cleanup = initReviewWidget({ container });
